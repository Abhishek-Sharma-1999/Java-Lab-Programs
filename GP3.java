...
class UIDriver {
 SimpleDateFormat formatter = new SimpleDateFormat("dd-MMMyyyy");
 void createView() {
 JFrame frame = new JFrame("GP3 Abhishek Sharma 03911604421");
 ...
 dataView(textField1.getText(),
textField2.getText(), date);
 });
 frame.add(display);
